...
import { ConfigEnvType, ConfigSetType } from '../../../src/fabric/model/type/config.type'
import config, { defaultEnv } from '../../../src/fabric/config'
...
describe('Config service: ', () => {
  ...
  describe('set', () => {
    ...
    it('should throw init first error message', () => {
      ...
      assert.throws(() => { (new Config(config)).set(configSetEnv) }, new ProcessError('Missing process: Run <bdk fabric config init> first'))
    })
