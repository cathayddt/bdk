...
const bdkPath = process.env.BDK_PATH || `${process.env.HOME}/.bdk/besu`
...
const nodeType = (() => {
  switch (process.env.BDK_BESU_NODE_TYPE) {
    case 'validator':
...
const config: Config = {
  ...
  networkName: process.env.BDK_BESU_NETWORK_NAME || 'bdk-besu-network',
  nodeType: nodeType,
