...
export default class BdkFile {
  ...
  public createArtifactsFolder () {
    fs.mkdirSync(`${this.bdkPath}/artifacts/besu`, { recursive: true })
  }

  public createGenesisJson (genesisJson: GenesisJsonType) {
    this.createArtifactsFolder()
    fs.writeFileSync(`${this.bdkPath}/artifacts/besu/genesis.json`, JSON.stringify(genesisJson, null, 2))
  }

  public createDisallowedNodesJson (disallowedNodesJson: Array<string>) {
    this.createArtifactsFolder()
    fs.writeFileSync(`${this.bdkPath}/artifacts/besu/disallowed-nodes.json`, JSON.stringify(disallowedNodesJson, null, 2))
  }

  public createStaticNodesJson (staticNodesJson: Array<string>) {
    this.createArtifactsFolder()
    fs.writeFileSync(`${this.bdkPath}/artifacts/besu/static-nodes.json`, JSON.stringify(staticNodesJson, null, 2))
  }
  ...
  public copyStaticNodesJsonToPermissionedNodesJson () {
    this.createArtifactsFolder()
    fs.copyFileSync(`${this.bdkPath}/artifacts/besu/static-nodes.json`, `${this.bdkPath}/artifacts/besu/permissioned-nodes.json`)
  }
  ...
  public copyGenesisJsonToValidator (i: number) {
    ...
    fs.copyFileSync(`${this.bdkPath}/artifacts/besu/genesis.json`, `${this.bdkPath}/validator${i}/data/genesis.json`)
  }

  public copyStaticNodesJsonToValidator (i: number) {
    this.createValidatorFolder(i)
    fs.copyFileSync(`${this.bdkPath}/artifacts/besu/static-nodes.json`, `${this.bdkPath}/validator${i}/data/static-nodes.json`)
  }

  public copyPermissionedNodesJsonToValidator (i: number) {
    this.createValidatorFolder(i)
    fs.copyFileSync(`${this.bdkPath}/artifacts/besu/permissioned-nodes.json`, `${this.bdkPath}/validator${i}/data/permissioned-nodes.json`)
  }
  ...
  public copyGenesisJsonToMember (i: number) {
    ...
    fs.copyFileSync(`${this.bdkPath}/artifacts/besu/genesis.json`, `${this.bdkPath}/member${i}/data/genesis.json`)
  }

  public copyStaticNodesJsonToMember (i: number) {
    this.createMemberFolder(i)
    fs.copyFileSync(`${this.bdkPath}/artifacts/besu/static-nodes.json`, `${this.bdkPath}/member${i}/data/static-nodes.json`)
  }

  public copyPermissionedNodesJsonToMember (i: number) {
    this.createMemberFolder(i)
    fs.copyFileSync(`${this.bdkPath}/artifacts/besu/permissioned-nodes.json`, `${this.bdkPath}/member${i}/data/permissioned-nodes.json`)
  }
  ...
  public getGenesisJson () {
    this.checkPathExist(this.bdkPath)
    const genesisJson = fs.readFileSync(`${this.bdkPath}/artifacts/besu/genesis.json`, 'utf8')
    return JSON.parse(genesisJson)
  }

  public getStaticNodesJson () {
    this.checkPathExist(this.bdkPath)
    const staticNodesJson = fs.readFileSync(`${this.bdkPath}/artifacts/besu/static-nodes.json`, 'utf8')
  ...
  public getPermissionedNodesJson () {
    this.checkPathExist(this.bdkPath)
    const permissionedNodesJson = fs.readFileSync(`${this.bdkPath}/artifacts/besu/permissioned-nodes.json`, 'utf8')
