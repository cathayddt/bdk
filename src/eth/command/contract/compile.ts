...
import ora from 'ora'
import Contract, { getFileChoices, fetchSolcVersions, loadRemoteVersion, getPragmaVersion, findVersionAndEvm } from '../../service/contract'
...
export const handler = async (argv: Arguments<OptType>) => {
  ...
  if (compileFunction === CompileType.REMOTE_SOLC) {
    ...
    const version = findVersionAndEvm(pragmaVersion, choices)
