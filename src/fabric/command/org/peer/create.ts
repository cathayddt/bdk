...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric org peer create --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric org peer create --file ~/.bdk/org-peer-create.json --create-full', '使用在路徑下 json 檔案中的參數，產生 Peer org 所需的相關設定檔案')
    .example('bdk fabric org peer create --file ~/.bdk/org-peer-create.json --cryptogen', '使用在路徑下 json 檔案中的參數和 cryptogen，產生憑證和私鑰')
    .example('bdk fabric org peer create --file ~/.bdk/org-peer-create.json --configtxJSON', '使用在路徑下 json 檔案中的參數和 configtx.yaml 產生 Peer org 的 json 檔案')
    .example('bdk fabric org peer create --file ~/.bdk/org-peer-create.json --connection-profile', '使用在路徑下 json 檔案中的參數，產生 Peer 連接設定檔案')
    .example('bdk fabric org peer create --file ~/.bdk/org-peer-create.json --docker-compose', '使用在路徑下 json 檔案中的參數，產生 Peer docker-compose 檔案')
