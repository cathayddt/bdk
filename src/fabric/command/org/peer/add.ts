...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric org peer add --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric org peer add --channel-name test --peer-org-name Org1', '將 Org1 加入 test 名稱的 Channel')
