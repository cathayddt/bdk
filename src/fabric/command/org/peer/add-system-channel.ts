...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric org peer add-system-channel --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric org peer add-system-channel --orderer orderer0.example.com:7050 --peer-org-name Org1', '使用 orderer0.example.com:7050 將 Org1 加入 System channel')
