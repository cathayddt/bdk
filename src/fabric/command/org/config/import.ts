...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric org config import --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric org config import --file ./test-import-config.json', '使用 ./test-import-config.json 匯入 org 至 Blockchain network 的資料夾底下')
