...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    ...
    .example('bdk fabric explorer up --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric explorer up --user alice --pass pass123 --port 8080', '建立 explore ，使用者帳號為 alice ，密碼為 pass123 ，使用的 port 是 8080')
}
