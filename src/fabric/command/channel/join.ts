...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric channel join --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric channel join --name test --orderer orderer0.example.com:7050', '使用 orderer0.example.com:7050 加入 test 名稱 Channel')
