...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric channel decode-envelope --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric channel decode-envelope --channel-name test', '解析 channel test 的更動資訊')
