...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric channel update --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric channel update --orderer orderer0.example.com:7050 --channel-name test', '使用 orderer0.example.com:7050 在名稱 test 的 channel 更新')
