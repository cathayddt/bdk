...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric channel create --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric channel create --name test --orderer orderer0.example.com:7050 --orgNames Org1 --orgNames Org2', '使用 orderer0.example.com:7050 建立有 Org1 和 Org2 的 test 名稱 Channel')
    .example('bdk fabric channel create --name test --orderer orderer0.example.com:7050 --orgNames Org1 --orgNames Org2 --channel-admin-policy-style Any-Member-in-Channel', '使用 orderer0.example.com:7050 建立有 Org1 和 Org2 的 test 名稱 Channel，其中 Channel Admin Policy 為有任何在 Channel 中的 Peer Org 簽名選項')
    .example('bdk fabric channel create --name test --orderer orderer0.example.com:7050 --orgNames Org1 --orgNames Org2 --channel-admin-policy-type Signature --channel-admin-policy-value OR(\'Org1.admin\', \'Org2.admin\')', '使用 orderer0.example.com:7050 建立有 Org1 和 Org2 的 test 名稱 Channel，其中 Channel Admin Policy 為有 Org1 和 Org2 任意一個 admin 身份的簽名')
    .example('bdk fabric channel create --name test --orderer orderer0.example.com:7050 --orgNames Org1 --orgNames Org2 --lifecycle-endorsement-style Any-Member-in-Channel', '使用 orderer0.example.com:7050 建立有 Org1 和 Org2 的 test 名稱 Channel，其中 Lifecycle Endorsement Policy 為有任何在 Channel 中的 Peer Org 簽名選項')
    .example('bdk fabric channel create --name test --orderer orderer0.example.com:7050 --orgNames Org1 --orgNames Org2 --lifecycle-endorsement-type Signature --lifecycle-endorsement-value OR(\'Org1.admin\', \'Org2.admin\')', '使用 orderer0.example.com:7050 建立有 Org1 和 Org2 的 test 名稱 Channel，其中 Lifecycle Endorsement Policy 為有 Org1 和 Org2 任意一個 peer 身份的簽名')
    .example('bdk fabric channel create --name test --orderer orderer0.example.com:7050 --orgNames Org1 --orgNames Org2 --endorsement-style Any-Member-in-Channel', '使用 orderer0.example.com:7050 建立有 Org1 和 Org2 的 test 名稱 Channel，其中 Endorsement Policy 為有任何在 Channel 中的 Peer Org 簽名選項')
    .example('bdk fabric channel create --name test --orderer orderer0.example.com:7050 --orgNames Org1 --orgNames Org2 --endorsement-type Signature --endorsement-value OR(\'Org1.admin\', \'Org2.admin\')', '使用 orderer0.example.com:7050 建立有 Org1 和 Org2 的 test 名稱 Channel，其中 Endorsement Policy 為有 Org1 和 Org2 任意一個 peer 身份的簽名')
