...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric channel update-anchorpeer --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric channel update-anchorpeer -n test -o orderer0.example.com:7050 -p 7051', '使用 orderer0.example.com:7050 更新 test 名稱 Channel 中 Anchor peer 資訊，此 Anchor peer 的 port 號碼為 7051')
