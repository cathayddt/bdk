...
export const builder = (yargs: Argv) => {
  return yargs
    .example('bdk fabric ca enroll --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric ca enroll -t client -u rca -p 7054 --client-id admin --client-secret adminpw --role rca --org-hostname rca', '登入名稱為 rca 的 CA 機器')
