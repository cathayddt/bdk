...
export const builder = (yargs: Argv) => {
  return yargs
    .example('bdk fabric ca register --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric ca register -t ica -a admin -u rca -p 7054 --client-id ica.example.com --client-secret icapw', '註冊名稱為 ica 的 CA 機器')
