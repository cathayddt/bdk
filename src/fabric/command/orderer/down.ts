...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric orderer down --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric orderer down -n OrdererOrg', '關閉名稱為 OrdererOrg 的 Orderer org 機器並且刪除其 volume 資料')
