...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric org orderer add consenter --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric org orderer add consenter --orderer orderer0.example.com:7050 -channel-name test --org-name OrdererOrg3 --hostname orderer0', '使用 orderer0.example.com:7050 的 Orderer 將 OrdererOrg3 中 Hostname 名稱為 orderer0 的設定檔資訊加入 Channel 名稱為 test中並且使用當下身份簽章')
