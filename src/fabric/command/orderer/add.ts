...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric orderer add --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric orderer add --orderer-hostnames orderer1', '在名稱為 BDK_ORG_DOMAIN 的 Orderer org 新增 Hostname 為 orderer1 的 Orderer')
