...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric chaincode package --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric chaincode package --chaincode-name fabcar --chaincode-version 1 --path ./chaincode/fabcar/go', '打包路徑位置 ./chaincode/fabcar/go 檔案為 fabcar 名稱版號為 1 的 Chaincode')
