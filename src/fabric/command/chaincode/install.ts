...
export const builder = (yargs: Argv<OptType>) => {
  return yargs
    .example('bdk fabric chaincode install --interactive', 'Cathay BDK 互動式問答')
    .example('bdk fabric chaincode install --chaincode-label test_1', '安裝名稱為 test 中標籤為 test_1 的 Chaincode')
